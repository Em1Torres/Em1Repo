...
describe("TC2005B Module Tests", () => {
    ...
    describe("firstNonerepeating", () => {
        it("empty string", () => {
            strictEqual(tc2005b.firstNonerepeating(""), "");
        });

        it("abcd", () => {
            strictEqual(tc2005b.firstNonerepeating("abcd"), "a");
        });

        it("abacddbec", () => {
            strictEqual(tc2005b.firstNonerepeating("abacddbec"), "e");
        });

        it("abacddbecef", () => {
            strictEqual(tc2005b.firstNonerepeating("abacddbecef"), "f");
        });
    });
