...
const englishMessages: TranslationMessages = {
    ra: {
        action: {
            add_filter: 'Agrega filtro',
            add: 'Agreaga',
            back: 'Anterior',
            bulk_actions: '1 item selected |||| %{smart_count} items selected',
            cancel: 'Cancelar',
            clear_array_input: 'Limpia la Lista',
            clear_input_value: 'Limpia el valor',
            clone: 'Clona',
            confirm: 'Confirma',
            create: 'Crea',
            ...
            list: 'Lista',
            refresh: 'Recargar',
            remove_filter: 'Elimina este filtro',
            remove_all_filters: 'Elimina todos los filtros',
            remove: 'Elimina',
            reset: 'Resetea',
            save: 'Salva',
            search: 'Busca',
            search_columns: 'Busca en columnas',
            select_all: 'Seleciona todos ',
            select_all_button: 'Seleciona todos',
            select_row: 'Seleciona esta fila ',
            show: 'Muestra',
            sort: 'Filtra',
            undo: 'Deshacer',
            unselect: 'Deseleciona',
            expand: 'Expande',
            close: 'Cierra',
            open_menu: 'Abre menu',
            close_menu: 'Cierra menu',
            update: 'Actualiza',
            move_up: 'Mueve arriba',
            move_down: 'Mueve abajo',
            open: 'Abre',
            toggle_theme: 'Cambia modo claro/oscuro ',
            select_columns: 'Columnas',
            update_application: 'Recarga Applicacion ',
        },
        boolean: {
            true: 'Yes',
            false: 'No',
